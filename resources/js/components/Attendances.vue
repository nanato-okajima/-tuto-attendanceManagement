<template>
  <div>
    <div class="panel panel-default" :key="attendance.id" v-for="attendance in attendances">
      <div class="panel-heading">
        <span clss="glyphicon glyphicon-user" id="start"></span>
      ...
      <div class="panel-footer">
        ...
        <span class="griphicon glyphicon-flag" id="comment"></span>
